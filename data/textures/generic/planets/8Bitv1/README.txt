...
Retro 8-bit Texture pack Install (This for the main pack not the add-on if your using add-on)
...
4. Take it to where you stored Retro 8-bit Texture pack.
5. Paste it inside Retro 8-bit Texture pack where it also says Assets.
6. It should ask you if you want to merge the folders, say yes.
7. Done.

How to install Add-On Packs (1.7.4 and up)
You install it the same way as Retro 8-bit Texture pack.
